...
// Used to uniquely identify elements that contain closures so that the PercyDom can
// look them up by their unique id.
// When the PercyDom sees that the element no longer exists it will drop all of it's
