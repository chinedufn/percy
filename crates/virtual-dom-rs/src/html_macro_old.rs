...
mod tests {
    ...
    fn one_prop() {
        ...
        test(HTMLMacroTest {
            generated: html_old! { <div id="hello-world",></div> },
            expected,
            desc: "One property",
        });
    }
    ...
    fn child_node() {
        ...
        test(HTMLMacroTest {
            generated: html_old! { <div><span></span></div> },
            expected,
            desc: "Child node",
        })
    }
    ...
    fn sibling_child_nodes() {
        ...
        test(HTMLMacroTest {
            generated: html_old! { <div><span></span><b></b></div> },
            expected,
    ...
    fn three_nodes_deep() {
        ...
        test(HTMLMacroTest {
            generated: html_old! { <div><span><b></b></span></div> },
            expected,
    ...
    fn nested_text_node() {
        ...
        test(HTMLMacroTest {
            generated: html_old! { <div>{ "This is a text node" } {"More" "Text"}</div> },
            expected,
    ...
    #[test]
    fn nested_macro() {
        let child_2 = html_old! { <b></b> };

        let mut expected = VirtualNode::new("div");
        expected.children = Some(vec![VirtualNode::new("span"), VirtualNode::new("b")]);

        test(HTMLMacroTest {
            generated: html_old! { <div>{ html_old! { <span></span> } { child_2 } }</div> },
            expected,
            desc: "Nested macros",
        });
    }
    ...
    fn strings() {
        ...
        test(HTMLMacroTest {
            generated: html_old! { <div>{ text1 text2 }</div> },
            expected,
    ...
    #[test]
    fn vec_of_nodes() {
        let children = vec![html_old! { <div> </div>}, html_old! { <strong> </strong>}];

        let mut expected = VirtualNode::new("div");
        expected.children = Some(vec![VirtualNode::new("div"), VirtualNode::new("strong")]);

        test(HTMLMacroTest {
            generated: html_old! { <div> { children } </div> },
            expected,
            desc: "Vec of nodes",
        });
    }
